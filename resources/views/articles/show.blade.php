...
<div id="wrapper">
    <div id="page">
        ...
        <h2>{{ $article->title }}</h2>
        <p class="pr-5">Written by {{ $article->author->name }} on {{ $article->created_at }} <span class="badge badge-success badge-pill">{{ $article->totalCommentsCount() }} comments</span></p>
